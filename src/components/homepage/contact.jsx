      ...
      >
        <div className="relative w-full h-full flex flex-col md:flex-row justify-center md:justify-between items-center gap-8 md:gap-32 overflow-hidden">
          <div className="flex flex-col overflow-hidden order-2 md:order-1">
            ...
            <Link
              className="block button mt-8 transition-all duration-500 ease-in-out [background:linear-gradient(45deg,#172033,theme(colors.neutral.100)_50%,#172033)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.neutral.200/.48)_80%,_theme(colors.neutral.300)_86%,_theme(colors.neutral.100)_90%,_theme(colors.neutral.300)_94%,_theme(colors.neutral.200/.48))_border-box] rounded-2xl border border-transparent animate-border hover:brightness-150"
